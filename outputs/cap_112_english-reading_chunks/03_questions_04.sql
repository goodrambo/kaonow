...
SELECT
  ...
  source, source_meta,
  is_active, auto_gradable, difficulty, explanation
FROM jsonb_to_recordset('[{"id": "cap-112-english-reading-043", "exam_id": "cap", "subject_id": "sub-cap-english-reading", "paper_id": "cap-112-english-reading", "question_type": "single_choice", "question_text": "(A) how old they are", "options": ["", "who they speak to", "where they grew up", "whether they are men or women"], "correct_answer": 0, "correct_answer_json": null, "parent_question_id": "cap-112-english-reading-passage-42", "media": null, "source": "official", "source_meta": {"parser_version": "cap_v0.1", "merger_version": "cap_merger_v0.2", "parsed_at": "2026-04-25T19:26:41+00:00", "source_pdf_sha1": "cf3633650349", "answer_pdf_sha1": "16ca7e0abba6", "flags": ["option_incomplete"], "parse_confidence": 0.75, "original_question_number": 43, "raw_text": "43. (A) how old they are\n    (B) who they speak to\n    (C) where they grew up\n    (D) whether they are men or women\n\n\n\n\n"}, "is_active": false, "auto_gradable": false, "difficulty": 3, "explanation": null}]'::jsonb) AS t(
